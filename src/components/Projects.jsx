  ...
  return (
    <section id="projects" className="section container">
      ...
      <div className="row g-4">
        ...
        <div className="col-12">
          <div className="card project-card p-4 h-100">
            <h4 className="text-white mb-3">Clinic Management SaaS Platform</h4>

            <p className="project-desc">
              Multi-tenant MERN SaaS with role-based access, appointment
              scheduling, JWT authentication, deployed on AWS EC2 with CI/CD &
              NGINX.
            </p>

            <b>
              Note: Application availability is scheduled from 8:30 AM to 1:30
              AM IST to optimize AWS EC2 infrastructure costs
            </b>
